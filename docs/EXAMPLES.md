...
|---------|-------------|---------|
| [latency](../examples/latency/) | Latency analysis patterns | 4 |
| [errors](../examples/errors/) | Error tracking and analysis | 5 |
| [traffic](../examples/traffic/) | Traffic and capacity analysis | 5 |
| [sli](../examples/sli/) | SLI/SLO metric tracking | 6 |
| [traces](../examples/traces/) | Distributed trace analysis | 5 |
